...
const runtimeReadyMcpPayload = JSON.parse(JSON.parse(runtimeContractMcpLines[9]).result.content[0].text);
const runtimeContractMcpPayload = JSON.parse(JSON.parse(runtimeContractMcpLines[10]).result.content[0].text);
if (
  ...
  console.error("[smoke:metadata-doctor-commands-entry-help-init-option-help-ready-contract-mcp] expected MCP metadata, doctor, command catalog, command entry, command help, init options, init option, init help, readiness, and contract views");
