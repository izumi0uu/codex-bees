...
const runtimeReadyMcpPayload = JSON.parse(JSON.parse(runtimeContractMcpLines[5]).result.content[0].text);
const runtimeContractMcpPayload = JSON.parse(JSON.parse(runtimeContractMcpLines[6]).result.content[0].text);
if (
  ...
  console.error("[smoke:metadata-doctor-commands-entry-ready-contract-mcp] expected MCP metadata, doctor, command catalog, command entry, readiness, and contract views");
