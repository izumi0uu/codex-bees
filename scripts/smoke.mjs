...
const runtimeReadyMcpPayload = JSON.parse(JSON.parse(runtimeContractMcpLines[3]).result.content[0].text);
const runtimeContractMcpPayload = JSON.parse(JSON.parse(runtimeContractMcpLines[4]).result.content[0].text);
if (
  ...
  console.error("[smoke:metadata-doctor-ready-contract-mcp] expected MCP metadata, doctor, readiness, and contract views");
