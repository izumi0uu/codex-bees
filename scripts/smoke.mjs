...
const runtimeReadyMcpPayload = JSON.parse(JSON.parse(runtimeContractMcpLines[4]).result.content[0].text);
const runtimeContractMcpPayload = JSON.parse(JSON.parse(runtimeContractMcpLines[5]).result.content[0].text);
if (
  ...
  console.error("[smoke:metadata-doctor-commands-ready-contract-mcp] expected MCP metadata, doctor, commands, readiness, and contract views");
