...
[![Surface](https://img.shields.io/badge/surface-TUI%20%2B%20CLI%20%2B%20MCP-0f766e?style=flat-square)](./docs/cli.md)
...
npx codex-bees
npx codex-bees --help
npx codex-bees --snapshot --section focus
...
- `j/k`, `Ctrl+N/Ctrl+P`, `gg`, `G` navigate launcher results
...
- launcher history lanes for recent commands and result review
...
- **TUI** is the default human entry and gives you a navigable terminal dashboard on top of the same runtime views
