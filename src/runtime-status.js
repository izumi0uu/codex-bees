...
const CAPABILITY_CATALOG = [
  ...
  },
  {
    ...
    cliCommands: ["catalog", "status", "capabilities", "doctor", "runtime:activity", "runtime:closeout", "runtime:dashboard", "runtime:dispatch", "runtime:focus", "runtime:handoffs", "runtime:recovery", "runtime:review", "runtime:alerts", "runtime:roles"],
    mcpTools: ["runtime_catalog", "runtime_status", "runtime_capabilities", "runtime_activity", "runtime_closeout", "runtime_dashboard", "runtime_dispatch", "runtime_focus", "runtime_handoffs", "runtime_recovery", "runtime_review", "runtime_alerts", "runtime_roles"]
  }
];
