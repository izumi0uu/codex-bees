...
const CAPABILITY_CATALOG = [
  ...
  },
  {
    ...
    cliCommands: ["leader:assignment-dispatch", "leader:assignment-dispatch-pack", "leader:assignments", "leader:queue", "leader:workspace", "swarm:brief", "swarm:bundle", "swarm:blockers", "swarm:closeout", "swarm:dispatch-bundle", "swarm:overview"],
    mcpTools: ["leader_assignment_dispatch", "leader_assignment_dispatch_pack", "leader_assignments", "leader_queue", "leader_workspace", "swarm_brief", "swarm_bundle", "swarm_blockers", "swarm_closeout", "swarm_dispatch_bundle", "swarm_overview"]
  },
  {
