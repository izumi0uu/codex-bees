...
const CAPABILITY_CATALOG = [
  ...
  },
  {
    ...
    cliCommands: ["mcp"],
    mcpTools: ["package_metadata", "runtime_doctor", "command_catalog", "runtime_ready", "runtime_contract", "runtime_catalog", "runtime_status", "runtime_capabilities", "runtime_capability"]
  },
  {
    id: "planning",
    category: "planning",
