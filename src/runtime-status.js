...
const CAPABILITY_CATALOG = [
  ...
  },
  {
    ...
    cliCommands: ["catalog", "status", "capabilities", "doctor", "runtime:dashboard", "runtime:dispatch", "runtime:alerts", "runtime:roles"],
    mcpTools: ["runtime_catalog", "runtime_status", "runtime_capabilities", "runtime_dashboard", "runtime_dispatch", "runtime_alerts", "runtime_roles"]
  }
];
