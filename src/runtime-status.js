...
const CAPABILITY_CATALOG = [
  ...
  },
  {
    ...
    cliCommands: ["catalog", "status", "capabilities", "doctor", "runtime:dashboard", "runtime:alerts"],
    mcpTools: ["runtime_catalog", "runtime_status", "runtime_capabilities", "runtime_dashboard", "runtime_alerts"]
  }
];
