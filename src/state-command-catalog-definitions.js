export function getBaseCommandCatalogDefinitions({ getInitCommandCatalog, getMcpCommandCatalog }) {
  return [
    ...
    { command: "runtime:control-pack", description: "Build the compact-by-default automation/control runtime package" },
    ...
    { command: "runtime:summary-pack", description: "Build the compact-by-default automation-first summary package with launch context" },
    ...
    { command: "plan:profiles", description: "Show the shipped planner profile catalog view" },
    { command: "plan:profile", description: "Show one shipped planner profile view" },
