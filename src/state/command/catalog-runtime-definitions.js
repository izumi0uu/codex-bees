export function getRuntimeCommandCatalogDefinitions() {
  return [
    ...
    { command: "runtime:dispatch-ranking", description: "Rank runtime dispatch candidates across owner groups" },
    ...
    { command: "runtime:focus-candidates", description: "Expose the ranked runtime focus candidates before final selection" },
