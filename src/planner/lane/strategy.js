import { inferPlannerIntent, touchesPublicRuntime } from "../scope/index.js";
import { COORDINATION_SIGNAL_TERMS } from "../profile/specs.js";
...
export function derivePlannerStrategy(task, implementationScope, intent = inferPlannerIntent(task, implementationScope), plannerProfile = null) {
  ...
  const needsDocumentation = !intent.docsOnly && (
    ...
    intent.catalog ||
    (coordinationDocumentationSidecar && strongCoordinationSignal)
  );
